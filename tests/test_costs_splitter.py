...
def test_get_pay():
    ...
    project = {'St.Brutto - Steuerbrutto': '0.0', 'BezPausch - Pauschal versteuerte Bezüge': '533'}
    expected_pay = '533'
    returned_pay = costs_splitter.get_pay(project)
    assert expected_pay == returned_pay

def test_get_social_insurance():
    project = {'KV-AG-Beitrag': '187.23', 'RV-AG-Beitrag': '213.65', 'AV-AG-Beitrag': '29.86', 'PV-AG-Beitrag': '39.05'}
    ...
    project = {'KV-AG-Beitrag': None, 'RV-AG-Beitrag': None, 'AV-AG-Beitrag': None, 'PV-AG-Beitrag': None}
    expected_insurance = 0.0
    returned_insurance = costs_splitter.get_social_insurance(project)
    assert expected_insurance == returned_insurance

def test_get_surcharges():
    project = {'U1 - Umlage 1': '55.13', 'U2 - Umlage 2': '8.96', 'InsoU - Insolvenzgeldumlage': '1.38'}
    ...
    project = {'U1 - Umlage 1': None, 'U2 - Umlage 2': None, 'InsoU - Insolvenzgeldumlage': None}
...
def test_get_keys_and_value_list_of_projects():
    ...
    returned_keys_and_value_list = costs_splitter.get_keys_and_value_list_of_projects("Björn", project)
...
def test_create_formulas_for_projects():
    ...
    returned_splitted_values_dict = costs_splitter.create_formulas_for_projects(keys_and_value_list, divisor, splitted_values_dict)
...
def test_get_keys_and_value_list_of_project():
    ...
    returned_keys_and_value_list = costs_splitter.get_keys_and_value_list_of_project(project)
    assert expected_keys_and_value_list == returned_keys_and_value_list
...
def test_create_formulas_for_accounting_person():
    ...
    returned_splitted_values_dict = costs_splitter.create_formulas_for_accounting_person(project_id, keys_and_value_list, divisor, splitted_values_dict)
    assert expected_splitted_values_dict == returned_splitted_values_dict
...
def test_create_formulas_for_cleaning_person():
    ...
    returned_splitted_values_dict = costs_splitter.create_formulas_for_cleaning_person(project_id, keys_and_value_list, splitted_values_dict)
    assert expected_splitted_values_dict == returned_splitted_values_dict
...
def test_create_formulas_for_project():
    ...
    returned_splitted_values_dict = costs_splitter.create_formulas_for_project(keys_and_value_list, divisor, splitted_values_dict)
    assert expected_splitted_values_dict == returned_splitted_values_dict    
...
def test_split():
    ...
    expected_splitted_values_list = [
        {'project_id': '0026_comM', 'Gehalt Björn': '=ROUND(-2297.29/24*20.0, 2)', 'Sozialv. Björn': '=ROUND(-469.79/24*20.0, 2)', 'Umlagen Björn': '=ROUND(-65.47/24*20.0, 2)', 'bAV Björn': '=ROUND(-75.0/24*20.0, 2)', 'Edenred Björn': '=ROUND(-50.0/24*20.0, 2)', 'AU-Erstattung Björn': '=ROUND(237.23/24*20.0, 2)'},
        {'project_id': '0054_comBüse', 'Gehalt Björn': '=ROUND(-2297.29/24*4.0, 2)', 'Sozialv. Björn': '=ROUND(-469.79/24*4.0, 2)', 'Umlagen Björn': '=ROUND(-65.47/24*4.0, 2)', 'bAV Björn': '=ROUND(-75.0/24*4.0, 2)', 'Edenred Björn': '=ROUND(-50.0/24*4.0, 2)', 'AU-Erstattung Björn': '=ROUND(237.23/24*4.0, 2)'},
        {'project_id': '0005_Präv', 'Gehalt Alan': '=ROUND(-3675.67/40*7.0, 2)', 'Sozialv. Alan': '=ROUND(-749.47/40*7.0, 2)', 'Umlagen Alan': '=ROUND(-142.99/40*7.0, 2)', 'bAV Alan': '=ROUND(-150.0/40*7.0, 2)', 'HVV Alan': '=ROUND(-46.55/40*7.0, 2)', '1&1 Alan': '=ROUND(-7.99/40*7.0, 2)', 'Edenred Alan': '=ROUND(-50.0/40*7.0, 2)'},
        {'project_id': '0009_Talk about ', 'Gehalt Alan': '=ROUND(-3675.67/40*13.0, 2)', 'Sozialv. Alan': '=ROUND(-749.47/40*13.0, 2)', 'Umlagen Alan': '=ROUND(-142.99/40*13.0, 2)', 'bAV Alan': '=ROUND(-150.0/40*13.0, 2)', 'HVV Alan': '=ROUND(-46.55/40*13.0, 2)', '1&1 Alan': '=ROUND(-7.99/40*13.0, 2)', 'Edenred Alan': '=ROUND(-50.0/40*13.0, 2)'},
        ...
        {'project_id': '0026_comM', 'Gehalt Birthe': '=ROUND(-533/40*20.0, 2)', 'Sozialv. Birthe': '=ROUND(-749.47/40*20.0, 2)', 'Umlagen Birthe': '=ROUND(-142.99/40*20.0, 2)', 'bAV Birthe': '=ROUND(-150.0/40*20.0, 2)', 'HVV Birthe': '=ROUND(-46.55/40*20.0, 2)', '1&1 Birthe': '=ROUND(-7.99/40*20.0, 2)', 'Edenred Birthe': '=ROUND(-50.0/40*20.0, 2)'},
    ...
    returned_splitted_values_list = costs_splitter.split_costs(projectlist, projects=True)
    ...
    returned_splitted_values_list = costs_splitter.split_costs(projectlist, projects=False)
    assert expected_splitted_values_list == returned_splitted_values_list