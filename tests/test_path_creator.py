...
def test_validate_path_exists():
    with pytest.raises(path_creator.PathNotFoundError):
        path_creator.validate_path_exists(
            ["../../test_data/raw_data/2024/24_01_24 MIST Januar 2024.xlsx"])
...
def test_get_paths():
    ...
    journal_data_file, employee_data_file, provisions_data_file, additional_costs_file, result_file_path = path_creator.get_paths(
        '0026', '25', "25_01_22 Lohnjournal Januar 2025.xlsx", "25_01")
