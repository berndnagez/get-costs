...
def test_append_row_to():
    ...
    returned_project_sheets = project_rows_creator.append_row_to('COSTS_SHEET_PROJECT', project_sheets, ('World', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'}))
    
    assert expected_project_sheets == returned_project_sheets

    expected_project_sheets = {
        'SURCHARGES_RETURN_SHEET': [
            ('Hello', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'}),
            ('World', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'}),
            ('And Hello Björn', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'})
            ],
        'COSTS_SHEET_PROJECT': [('Hello', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'}), ('World', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'})],
        'SURCHARGES_SHEET': [],
        'RIDE_COST_SHEET': [('HVV', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'})],
    ...
    returned_project_sheets = project_rows_creator.append_row_to('SURCHARGES_RETURN_SHEET', project_sheets, ('And Hello Björn', {'font_name': 'Arial', 'font_size': '10', 'align': 'left'}))
...
def test_distribute_values_to_sheets():
    ...
    project_rows_creator.distribute_values_to_sheets(splitted_values_list, project_id, datetime.date(2024, 1, 1), project_sheets)
