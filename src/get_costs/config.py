...
def get_paths_for(id):
    ...
    if id in paths:
        ...
        print(
            f"FEHLER: 'Für die Projekt-ID '{id}' konnten keine Pfade gefunden werden. Bitte ergänze die Pfadangeben in der Funktion 'get_paths_for' in der config.py.")
        exit('Programmabbruch.')


TABLE_FORMAT_HEAD = {'bold': True, 'font_name': 'Arial',
                     'font_size': '10', 'bg_color': '#dddddd', 'align': 'center'}
TABLE_FORMAT_HEAD_RIGHT = {'bold': True, 'font_name': 'Arial',
                           'font_size': '10', 'bg_color': '#dddddd', 'align': 'right'}
TABLE_FORMAT_HEAD_LEFT = {'bold': True, 'font_name': 'Arial',
                          'font_size': '10', 'bg_color': '#dddddd', 'align': 'left'}
...
COLUMN_WIDTH_VALUES_OF_COSTS = [
    (0, 1, 10), (2, 2, 24), (3, 3, 12), (4, 4, 22), (5, 6, 18)]
TABLE_HEAD_OF_COSTS = [
    ("Monat", TABLE_FORMAT_HEAD_RIGHT),
...
DATE_FORMAT = {'num_format': 'mmm yyyy',
               'font_name': 'Arial', 'font_size': '10'}
TEXT_FORMAT = {'font_name': 'Arial', 'font_size': '10', 'align': 'center'}
CURRENCY_FORMAT = {'num_format': '#,##0.00 [$€-407];[Red]-#,##0.00 [$€-407]',
                   'font_name': 'Arial', 'font_size': '10', 'align': 'right'}
CURRENCY_FORMAT_PROJECT = {
    'num_format': '#,##0.00 [$€-407];[Red]-#,##0.00 [$€-407]', 'font_name': 'Arial', 'font_size': '10', 'align': 'center'}

DATE_FORMAT_PROJECTS = {'bold': True, 'num_format': 'mmm yyyy',
                        'font_name': 'Arial', 'font_size': '10', 'bg_color': 'gray', 'align': 'left'}
TEXT_FORMAT_PROJECTS = {'font_name': 'Arial',
                        'font_size': '10', 'align': 'left'}
PROJECT_ID_FORMAT_PROJECTS = {'bold': True, 'font_name': 'Arial',
                              'font_size': '10', 'bg_color': 'gray', 'align': 'left'}


TABLE_FORMAT_FOOTER_SUM = {'bold': True, 'font_name': 'Arial',
                           'font_size': '10', 'bg_color': '#dddddd', 'align': 'right'}
...
def get_sheetnames_of(project_id):
    ...
    if project_id in sheet_names:
        ...
        print(
            f"FEHLER: 'Für die Projekt-ID '{project_id}' konnten keine sheet-names gefunden werden. Bitte ergänze die Pfadangeben in der Funktion 'get_sheetnames_of' in der config.py.")
        exit('Programmabbruch.')
...
def get_personal_of(project_id):
    ...
    if project_id in personal_ids:
        ...
        print(
            f"FEHLER: 'Für die Projekt-ID '{project_id}' konnten keine Personal-IDs gefunden werden. Bitte ergänze die Pfadangeben in der Funktion 'get_personal_of' in der config.py.")
        exit('Programmabbruch.')
